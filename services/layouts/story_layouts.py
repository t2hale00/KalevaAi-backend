...
Handles 2 different visual versions for stories with campaign banner in upper-right.
"""
...
class StoryLayoutHandler:
    """Handler for Portrait and Square story layouts with 2 visual versions."""
